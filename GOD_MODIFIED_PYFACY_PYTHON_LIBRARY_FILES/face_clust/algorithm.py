...
class Face_Clust_Algorithm():
	...
	def load_faces(self,externalFaceEmbeddingModelDirectory):
		if self.valid_path:
			self.encs,self.paths = load_images_to_clust_encodings(self.path,externalFaceEmbeddingModelDirectory)
