# WORLD'S FIRST OPEN SOURCE MASKED FACE *RECOGNITION* ARTIFICIAL INTELLIGENCE APP (SEE ALSO [MY STORED FACE VARIANT](https://github.com/JordanMicahBennett/MASKED-FACE-RECOGNITION-OR-PERIOCULAR-ARTIFICIAL-INTELLIGENCE-APP/blob/main/README.md))
